...
public class EntityClassGroup {
    ...
    static {
    	String remapped_method_30949 = ObfuscationReflectionHelper.findMethod(Entity.class, "m_7337_", Entity.class).getName();
    ...
    public static class NoDragonClassGroup extends EntityClassGroup {
        ...
        static {
        	String remapped_method_30948 = ObfuscationReflectionHelper.findMethod(Entity.class, "m_5829_").getName();
